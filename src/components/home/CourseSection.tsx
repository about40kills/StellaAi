          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="bg-gradient-to-br from-gray-900 to-black p-8 md:w-1/2">
              <h3 className="mb-4 text-2xl font-bold text-white">
                How Early Protein Modeling Advanced to AI-Driven Drug Discovery with Stella Ai
              </h3>
              <div className="mb-6 flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    Stanford professor, a member of Stella Ai's Scientific Advisory Board, won the Nobel Prize in
              ...
              <p className="text-gray-300">
                ...
                Now, says Dr. Levitt, Stella Ai is using AI to create an entirely new AI-driven drug discovery pipeline
                from A to Z. Using aging as a way to identify disease, he says, Stella Ai has trained AI to do what it does best
